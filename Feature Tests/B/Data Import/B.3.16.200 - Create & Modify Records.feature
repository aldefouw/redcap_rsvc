...
# When I upload a "csv" format file located at "import_files/B.3.16.600_DataImport.csv", by clicking the button near "Upload your CSV file:" to browse for the file, and clicking the button labeled "Upload" to upload the file
...
Then I should NOT see "Create record (import)1" 
