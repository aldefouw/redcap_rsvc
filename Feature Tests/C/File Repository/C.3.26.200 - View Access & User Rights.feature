...
Scenario: C.3.26.200.100 Limit user view and export access based on User Rights and DAG
    ...
    Then I should see "test_user1 (Test User1)" user assigned "1_FullRights" role 

    When I click on the link labeled "test_user2 (Test User2)" 
    And I click on the button labeled "Assign to role" on the tooltip 
    And I select "1_FullRights" on the dropdown field labeled "Select Role"
    And I click on the button labeled exactly "Assign"
    Then I should see "test_user2 (Test User2)" user assigned "1_FullRights" role 
    ...
    And I click on the button labeled exactly "Assign"
    Then I should see "test_user3 (Test User3)" user assigned "3_ReadOnly_Deidentified" role 

    When I click on the link labeled "test_user4 (Test User4)" 
    And I click on the button labeled "Assign to role" on the tooltip 
    And I select "3_ReadOnly_Deidentified" on the dropdown field labeled "Select Role"
    And I click on the button labeled exactly "Assign"
    Then I should see "test_user4 (Test User4)" user assigned "3_ReadOnly_Deidentified" role 
