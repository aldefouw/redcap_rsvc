...
Scenario: C.3.26.200.100-F
    ...
    Then I should see a table header and rows containing the following values in the file repository table:
        ...
        | PDF Survey Archive          |                  |                         |
        | Recycle Bin                 |                  |                         |
        | user list for project 1.csv | mm/dd/yyyy hh:mm | Uploaded by test_admin. |
    ...
    Then I should see a downloaded file named "user list for project 1.csv"
    # And I wait for 5 seconds
